export var programData = [
    ...
    {
        title: "gnome",
        icon: "assets/gnome.svg",
        link: "programs/gnome.html",
        fileArray: ["CONTRIBUTING.md"],
        description: "GNOME is a free and open-source desktop environment for Linux and other Unix-like operating systems."
    },
    {
        title: "hyprland",
        icon: "assets/hyprland.svg",
        link: "programs/hyprland.html",
        fileArray: ["CONTRIBUTING.md"],
        description: "Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks."
    },
    {
        title: "xfce",  
        icon: "assets/xfce.svg",
        link: "programs/xfce.html", 
        fileArray: ["CONTRIBUTING.md"],
    ...
    //     link: "programs/waybar.html",
    //     fileArray: ["CONTRIBUTING.md"],
    //     description: "empty"
    // },
    {
        title: "micro",
        icon: "assets/micro.svg",
        link: "programs/micro.html",
    ...
    { 
        title: "bash",
        icon: "assets/bash.svg",
        link: "programs/bash.html",
        fileArray: [".bashrc"],
